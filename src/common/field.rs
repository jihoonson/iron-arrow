...
pub trait Field: BaseField + Cast {}
...
impl StructField {
  pub fn new(name: String, fields: Vec<Box<Field>>) -> StructField {
    StructField::create(name, true, fields, Option::None)
  }

  pub fn non_nullable(name: String, fields: Vec<Box<Field>>) -> StructField {
    StructField::create(name, false, fields, Option::None)
  }

  pub fn with_metadata(name: String, fields: Vec<Box<Field>>, metadata: KeyValueMetadata) -> StructField {
    StructField::create(name, true, fields, Option::from(metadata))
  }

  pub fn non_nullable_with_metadata(name: String, fields: Vec<Box<Field>>, metadata: KeyValueMetadata) -> StructField {
    StructField::create(name, false, fields, Option::from(metadata))
  }

  fn create(name: String, nullable: bool, fields: Vec<Box<Field>>, metadata: Option<KeyValueMetadata>) -> StructField {
    StructField {
      name,
...
impl UnionField {
  pub fn new(name: String, fields: Vec<Box<Field>>, type_codes: Vec<u8>) -> UnionField {
    UnionField::create(name, true, fields, type_codes, Option::None)
  }

  pub fn non_nullable(name: String, fields: Vec<Box<Field>>, type_codes: Vec<u8>) -> UnionField {
    UnionField::create(name, false, fields, type_codes, Option::None)
  }

  pub fn with_metadata(name: String, fields: Vec<Box<Field>>, type_codes: Vec<u8>, metadata: KeyValueMetadata) -> UnionField {
    UnionField::create(name, true, fields, type_codes, Option::from(metadata))
  }

  pub fn non_nullable_with_metadata(name: String, fields: Vec<Box<Field>>, type_codes: Vec<u8>, metadata: KeyValueMetadata) -> UnionField {
    UnionField::create(name, false, fields, type_codes, Option::from(metadata))
  }

  fn create(name: String, nullable: bool, fields: Vec<Box<Field>>, type_codes: Vec<u8>, metadata: Option<KeyValueMetadata>) -> UnionField {
    UnionField {
      name,
